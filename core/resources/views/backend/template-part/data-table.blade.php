...
<script src="{{url('/')}}/assets/backend/js/datatable.js" type="text/javascript"></script>
...
<script src="{{url('/')}}/assets/backend/js/table-datatables-buttons.js" type="text/javascript"></script>
