                ...
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="index-one.html">
                            ...
                            {{--@endif--}}
                            <img class="img-responsive" src="{{url('/')}}/assets/frontend/images/logo/logo.png" alt=""></a>
                    </div>
                    ...
                    <div id="navbar" class="navbar-collapse collapse">
                        ...
                        <ul class="nav navbar-nav">
                            <li class="dropdown has-submenu active">
                                ...
                                <!--Start Mega Menu-->
                                <ul class="mega-menu drop-down-menu">
                                    <li>
                                        <!--Start Mega Menu Row-->
                                        <div class="row">
                                            <!--Start Mega Menu Col-->
                                            <div class="col-sm-6 col-xs-12">
                                                <div class="mega-menu-links clearfix border">
                                                    <ul>
                                            ...
                                            <div class="col-sm-6 col-xs-12">
                                                <div class="mega-menu-links clearfix">
                                                    <ul>
                                                        <li><a href="index-transport-vehicle.html">Transport</a></li>
                                                        <li><a href="index-job-board.html">Job Board</a></li>
                                                        <li><a href="index-restaurant.html">Restaurant</a></li>
                                                        <li><a href="index-realestate.html">Real Estate</a></li>
                                                        <li><a href="index-ads.html">Classified Ads</a></li>
                                                        <li><a href="index-travel-hotel.html">Travel & Hotel</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <!--End Mega Menu Col-->
